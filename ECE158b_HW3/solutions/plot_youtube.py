...
#.pcap file
youtube_pcap  = '/Users/deltau/MyProjects/SC/Comp_Network/ECE_158b_HW3/solutions/youtube_cap2.pcap'

#collect time
pkts = rdpcap(youtube_pcap)
tm = []
for pkt in pkts:
    if pkt.dst == '8c:85:90:3d:5d:87' and pkt.haslayer('UDP'):
        if pkt.type == 34525:
            tm.append(pkt.time)
...
#plot
fig = plt.figure() 
plt.bar(timePoint, pC,width = 4,color = 'green')  
plt.show() 